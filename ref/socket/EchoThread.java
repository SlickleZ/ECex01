...
public class EchoThread extends Thread {
    ...
    public void run() {
         Scanner inFromClient = null; // message from user
         DataOutputStream outToClient = null; // output to client
         
         try {
            // init output, input socket
            ...
            String clientSentence = inFromClient.nextLine(); 
      	   ...
      	   outToClient.writeBytes(capitalizedSentence); // send it to client!
		   }
        catch (IOException e) {
